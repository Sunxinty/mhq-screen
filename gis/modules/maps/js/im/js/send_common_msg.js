...
function onSendMsg() {
    //获取消息内容
    var msgContent = "{\"userAction\": \"15\",\"subcmd\": \"INVITE\",\"room\": \"1\",\"isVideo\": \"true\",\"isSingle\": \"true\",\"caller\": \"ocean\"}";
...
function handleMsgSend(msgContent){
    if (!selSess) {
        var selSess = new webim.Session(selType, "ocean", "ocean", friendHeadUrl, Math.round(new Date().getTime() / 1000));
    }
